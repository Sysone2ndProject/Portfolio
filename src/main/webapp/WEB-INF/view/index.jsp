...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/TeamMainPage.css" />
</head>
<script>
  function sendGetRequest() {
    const url = "${pageContext.request.contextPath}/members/juni";
                ...
                <ul class="subnav">
                    ...
                    <li class="card-med" id="serv-board">
                        ...
                        <a href="#">
                            <span>Boarding</span>
                            <span
                            >More Info<span class="material-symbols-outlined">
                      arrow_forward
                    </span></span
                            >
                        </a>
...
<section class="hero">
    <h1>똑~똑! 여기 맡겨도 될까요~? 어서오시개~.~</h1>
    <div class="btn-group">
        <button class="btn-filled-dark">
            <span class="material-symbols-outlined"> shopping_cart </span>Shop All
            Products
        </button>
    ...
    <ul class="shop-pets">
        <li class="card-large card-light" id="sup-dog">
            ...
            <ul>
                ...
                <button class="btn-outline-light" >
                    Shop All<span class="material-symbols-outlined">
                arrow_forward
              </span>
                </button>
            </ul>
        ...
        <li class="card-large card-dark" id="sup-bird">
            ...
            <ul>
                ...
                <button class="btn-outline-dark" onclick="sendGetRequest()">
                    Shop All<span class="material-symbols-outlined">
                arrow_forward
              </span>
                </button>
...
<section>
    ...
    <ul class="services">
        <li class="card-large card-dark card-wide" id="serv-groom">
            ...
            <ul>
                Dog Grooming<span class="subtitle"
            >Tail-wagging transformations are our specialty.</span
            >
        ...
        <li class="card-large card-dark card-wide" id="serv-board">
            ...
            <ul>
                Dog Boarding<span class="subtitle"
            >Where fun and care never take a day off.</span
            >
...
<section id="locate">
    <div>
        ...
        <div class="btn-group">
            <button class="btn-filled-dark">
                <span class="material-symbols-outlined"> pin_drop </span>Find a
                Store
            </button>
            <button class="btn-outline-dark btn-hover-color">
